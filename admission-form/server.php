...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO all_data (enroll_code, profile_img, registration_no, password, date_of_registration, counsellor_name, handle_by, student_name, father_name, course, session, phone, bed, deled, med, payment, register_amount, register_date, allotment_amount, allotment_date, 1yr_exam_amount, 1yr_exam_date, 2yr_exam_amount, 2yr_exam_date, migration_fine, practical_file_charge, conveyance_charge, programme, university, session2, medium, student_name2, date_of_birth, religion, gender, married, cetegory, disabilities, adhaar, nation, resident, income, phone2, phone3, email, father_name2, mother_name, defense, dependent, address, pin, university_location, university_group, teaching_sub1, teaching_sub2, university10, passing_year10, roll_no10, obtained10, total_marks10, per10, university12, passing_year12, roll_no12, obtained12, total_marks12, per12, university_ug, passing_year_ug, roll_no_ug, obtained_ug, total_marks_ug, per_ug, university_pg, passing_year_pg, roll_no_pg, obtained_pg, total_marks_pg, per_pg, university_other, passing_year_other, roll_no_other, obtained_other, total_marks_other, per_other, fee_declare, declare_eligibility, fee_plan, instrument, issue_date, bank_details, amount, instrument2, issue_date2, bank_details2, amount2, instrument3, issue_date3, bank_details3, amount3, instrument4, issue_date4, bank_details4, amount4, agree, agree_date, place, understand, understand_date, place2, vailid_document, vailid_document_date, place3, sincerity, leadership, imagination, emotional_stability, ability, work_hard, perseverance, declaration, declaration2, declaration_date, place4, declaration3, course_admission, vailid_photocopy, vailid_photocopy_date, place5, fee_plan2, card_before, concerned, admit_card, admit_card_concerned, student_signature,parent_signature_sig, services, student_name3, student_date, parents_name, parent_address) VALUES ('$code','$profile_newname','$registration_no','$password','$date_of_registration','$counsellor_name','$handle_by','$student_name','$father_name','$course','$session','$phone','$bed','$deled','$med','$payment','$register_amount','$register_date','$allotment_amount','$allotment_date','$fyr_exam_amount','$fyr_exam_date','$syr_exam_amount','$syr_exam_date','$migration_fine','$practical_file_charge','$conveyance_charge','$programme','$university','$session2','$medium','$student_name2','$date_of_birth','$religion','$gender','$married','$cetegory','$disabilities','$adhaar','$nation','$resident','$income','$phone2','$phone3','$email','$father_name2','$mother_name','$defense','$dependent','$address','$pin','$university_location','$university_group','$teaching_sub1','$teaching_sub2','$university10','$passing_year10','$roll_no10','$obtained10','$total_marks10','$per10','$university12','$passing_year12','$roll_no12','$obtained12','$total_marks12','$per12','$university_ug','$passing_year_ug','$roll_no_ug','$obtained_ug','$total_marks_ug','$per_ug','$university_pg','$passing_year_pg','$roll_no_pg','$obtained_pg','$total_marks_pg','$per_pg','$university_other','$passing_year_other','$roll_no_other','$obtained_other','$total_marks_other','$per_other','$fee_declare','$declare_eligibility','$fee_plan','$instrument','$issue_date','$bank_details','$amount','$instrument2','$issue_date2','$bank_details2','$amount2','$instrument3','$issue_date3','$bank_details3','$amount3','$instrument4','$issue_date4','$bank_details4','$amount4','$agree','$agree_date','$place','$understand','$understand_date','$place2','$vailid_document','$vailid_document_date','$place3','$sincerity','$leadership','$imagination','$emotional_stability','$ability','$work_hard','$perseverance','$declaration','$declaration2','$declaration_date','$place4','$declaration3','$course_admission','$vailid_photocopy','$vailid_photocopy_date','$place5','$fee_plan2','$card_before','$concerned','$admit_card','$admit_card_concerned','$student_signature_newname','$parent_signature_sig_newname','$services_imploded','$student_name3','$student_date','$parents_name','$parent_address')";


    if (mysqli_query($conn, $sql)) {
        echo "<script language='javascript'>";
        echo "alert('Admission Form Submitted Successfully. We Will Contact You Shortly.');";
